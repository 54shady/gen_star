...
ANDROID_TOP_DIR_3288_4="/home/zeroway/3288/src/3288_4.4"
...
make_update_3288_4()
{
	# 3288 android 4.4 target images
	TARGET_KERNEL_IMG="$ANDROID_TOP_DIR_3288_4/out/target/product/rk3288/obj/KERNEL/kernel.img"
	TARGET_RESOURCE_IMG="$ANDROID_TOP_DIR_3288_4/out/target/product/rk3288/obj/KERNEL/resource.img"
	TARGET_RECOVERY_IMG="$ANDROID_TOP_DIR_3288_4/rockdev/Image-rk3288/recovery.img"
	TARGET_SYSTEM_IMG="$ANDROID_TOP_DIR_3288_4/rockdev/Image-rk3288/system.img"
	TARGET_BOOT_IMG="$ANDROID_TOP_DIR_3288_4/rockdev/Image-rk3288/boot.img"
	TARGET_MISC_IMG="$ANDROID_TOP_DIR_3288_4/rockdev/Image-rk3288/misc.img"
	target_imgs=(
		$TARGET_KERNEL_IMG
		$TARGET_RESOURCE_IMG
		$TARGET_RECOVERY_IMG
...
print_usage()
{
	...
	echo "genupdate 32885 ==> 3288 5.1"
	echo "genupdate 32884 ==> 3288 5.1"
	echo "genupdate 32884"
	echo "genupdate 3368"
}
